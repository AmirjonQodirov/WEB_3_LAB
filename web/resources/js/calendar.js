...
function calendar() {
    ...
    months = new Array('Январь', 'Февраль', 'Март', 'Фпрель', 'Май', 'Июнь', 'Июль', 'Август', 'Сентябрь', 'Октябрь', 'Ноябрь', 'Декабрь');
    ...
    document.write('<tr class="cal_d_weeks"><th>Вс</th><th>Пн</th><th>Вт</th><th>Ср</th><th>Чт</th><th>Пт</th><th>Сб</th></tr><tr>');
    week = 0;
    for (i = 1; i <= beg_j; i++) {
    ...
    opacity(document.getElementById('calendar'), 70);
    return true
}
